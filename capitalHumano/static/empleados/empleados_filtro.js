...
Grid.prototype.get_Columnas = function () {
    ...
    return [
        ...
        { field: "pers_fecha_nacimiento", title: "Fecha de nacimiento", width: "120px" },
        { field: "pers_ciudad_nacimiento", title: "Ciudad de nacimiento", width: "120px" },
        { field: "pers_estado_nacimiento", title: "Estado de nacimiento", width: "120px" },
        { field: "pers_pais_nacimiento_clave", title: "País de nacimiento", width: "120px" },
        ...
        { field: "asig_fecha_inicio", title: "Fecha inicio asignación", width: "100px", format: "{0:dd-MM-yyyy}" },
        { field: "asig_organizacion_desc", title: "Organización", width: "150px" },
        { field: "asig_trabajo_desc", title: "Trabajo", width: "100px" },
        { field: "asig_grado_desc", title: "Grado", width: "120px" },
        { field: "asig_ubicacion_desc", title: "Ubicación", width: "130px" },
        { field: "asig_puesto_desc", title: "Puesto", width: "150px" },
        { field: "asig_jefe_directo_desc", title: "Jefe directo", width: "150px" },
        ...
        { field: "grup_proyecto_code_jde", title: "Proyecto cod. JDE", width: "100px" },
        { field: "grup_proyecto_jde", title: "Proyecto JDE", width: "100px" },
        ...
        { field: "metodo_pago", title: "Detalle adicional", width: "100px" },
