...
@register.inclusion_tag(
    ...
    takes_context=False)
def tag_field_popup_datepicker(_field, _size_label, _size_field):
...
@register.inclusion_tag(
    'tags/field_popup_dates.html',
    takes_context=False)
def tag_field_popup_dates(_label, _field1, _field2):
...
@register.inclusion_tag(
    'tags/field_popup_checkbox.html',
    takes_context=False)
def tag_field_popup_checkbox(_field, _size_label, _size_field):
