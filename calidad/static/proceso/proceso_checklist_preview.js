...
TarjetaResultados.prototype.get_TextoDinamico = function () {
   ...
   var espacio_total = this.get_Pixeles(279.4) //Espacio total del pdf en pixeles(1167.875449). Nota: En media print, por alguna razon el alto del pdf es de 309mm para tamaño carta de hoja
   var espacio_disponible = espacio_total - (this.$mt + this.$mb)


   this.$texto_dinamico.find('.nova-dinamic').each(function(index, element) {
      console.log(index + " " + $(element).outerHeight( true ) + " " + $(element).html()  );
