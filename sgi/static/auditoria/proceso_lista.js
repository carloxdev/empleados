...
function TarjetaModalNuevo() {
    ...
    this.$id_representante_area = $("#id_representante_area")
...
TarjetaModalNuevo.prototype.init_Components = function () {
    ...
    this.$id_representante_area.select2(this.get_ConfSelect2())
    ...
    this.$id_auditor.select2(this.get_ConfSelect2())
    this.$id_sitio.select2(this.get_ConfSelect2())
...
TarjetaModalNuevo.prototype.get_ConfWysi = function () {
    return {
        toolbar: {
            "font-styles": true,
            "emphasis": true,
...
TarjetaModalNuevo.prototype.get_DateTimePickerConfig = function () {
    return {
        autoclose: true,
...
TarjetaModalNuevo.prototype.get_ConfDate = function () {
...
Grid.prototype.get_FuenteDatosExcel = function (e) {
    ...
    return {
        ...
        transport: {
            ...
            parameterMap: function (data, action) {
                if (action === "read"){
                    return tarjeta_modal_nuevo.get_FiltrosExcel()
                }
            }
        },
        schema: {
