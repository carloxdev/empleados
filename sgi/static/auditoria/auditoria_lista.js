...
TarjetaFiltros.prototype.init_Components = function () {
    this.$id_elaborador.select2(this.get_ConfSelect2())
    this.$id_autorizador.select2(this.get_ConfSelect2())
    this.$id_aprobador.select2(this.get_ConfSelect2())
    this.$id_estado.select2(this.get_ConfSelect2())
    this.$id_compania_auditada.select2(this.get_ConfSelect2())
