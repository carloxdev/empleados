...
class IncidenciaDocumentoNuevo(View):
    ...
    def post(self, request):
        ...
        if formulario.is_valid():
            ...
            return redirect(reverse('seguridadlaboral:incidencia_archivo', kwargs={'incidencia_id': incidencia.pk}))
...
class IncidenciaDocumentoEditar(View):
    ...
    def post(self, request, pk):
        ...
        if formulario.is_valid():
            ...
            return redirect(reverse('seguridadlaboral:incidencia_lista'))
...
class IncidenciaResolucionNuevo(View):
    ...
    def post(self, request, incidencia_id):
        ...
        if formulario.is_valid():
            ...
            #return redirect(reverse('sgi:incidencia_lista'))
            return redirect(reverse('seguridadlaboral:incidencia_archivo', kwargs={'incidencia_id': Incidencia_Resolucion.incidencia_id }))
